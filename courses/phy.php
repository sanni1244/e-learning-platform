    ...
    for(let i = 0; i < physicsCourses.length; i++){
        html += `
                <div class="individual">
                    <div>
    <img class="detailsimg" src="${physicsCourses[i].img}" alt="">
</div>
<div>
    <div><span class="details">${physicsCourses[i].courseCode}</span></div>
    <div><span class="details">${physicsCourses[i].name}</span></div>
    <div><span class="details">${physicsCourses[i].level}</span></div>
    <div><span class="details"><a href="${physicsCourses[i].mylink}">Check Materials</a></span></div>              
</div>
                     </div>`
