let computerCourses = [
    ...
    //     courseCode: "CSC 132",
    //     name: "PRINCIPLES OF PROGRAMMING LANGUAGE I",
    //     level: "100 Level",
    //     material_no: "1",
    //     location: "./material/csc111/1.ppt",
    //     mylink: "/vent/personal/link.php?aq=csc112"
...
function computer(){
    ...
    for(let i = 0; i < 6; i++){
        ...
        <div class="sect">
        <div class="section">
                <img class="row" src="${computerCourses[i].img}" alt="">
                    <div><span class="row">${computerCourses[i].courseCode}</span></div>
                <div><span class="row">${computerCourses[i].name.charAt(0).toUpperCase() + computerCourses[i].name.substring(1, 500).toLowerCase()}</span></div>

                    <div><span class="row">${computerCourses[i].level}</span></div>
                    <div><span class="row"><a href="${computerCourses[i].mylink}">Check Materials</a></span></div>
            </div>
        </div>`
