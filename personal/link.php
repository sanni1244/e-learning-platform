...
<div class="one left">
            <a href="/elearning/personal/allcourses.php"><div class="brand"><h4 class="h4">YEET KNOWLEDGE</h4></div></a>
    ...
    if(isset($_GET["aq"])){
        if($_GET["aq"]){ 
            ...
            if(mysqli_num_rows($query) == 0){
                header("location:/elearning/personal/allcourses.php");
            }
    ...
    if(mysqli_num_rows($yr1) !== 0){
        echo "<a href='/elearning/personal/link.php?aq={$rtr}&enr=yes'><div class='enrol enrolled'><b>Added</b></div></a>";}
    else{
        echo "<a href='/elearning/personal/link.php?aq={$rtr}&enr=no'><div class='enrol'><b>Add To My Courses</b></div></a>";
        }      
...
$.getJSON('./elist.json', function(data) {
   $.each(data[creater], function(i, f) {
      var tblRow = "<p  class='yyy'>" + "<span>" + f.materialname + "</span><a href='" + f.link + "'><img class='dwl' src='/elearning/icons/download.png'></a></p>"
