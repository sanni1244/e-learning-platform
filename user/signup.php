...
<form class="form" id="thediv" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
        <div class="signup-section">
            <div class="cntn1">
                <label for="">First Name<sup title="This field is required">*</sup></label>
                <input class="lbl1" value="<?php echo @$_POST['firstname']; ?>" placeholder= "<?php echo $blankfname ?>" type="text" name="firstname" id=""></input> 
            </div>
            <div class="cntn1">
                <label for="">Last Name<sup title="This field is required">*</sup></label>
                <input class="lbl1" value="<?php echo @$_POST['lastname']; ?>" placeholder="<?php echo $blanklname ?>" type="text" name="lastname" id=""></input>    
            </div>
        </div>
        <div class="signup-section">
            <div class="cntn1">
                <label for="">Email<sup title="This field is required">*</sup></label>
                <input class="lbl1" value="<?php 
                    if($blankemail == " "){
                        echo @$_POST['email'];
                    }
                ?>" placeholder="<?php echo $blankemail ?>" type="email" name="email" id=""></input>      
            </div>
            <div class="cntn1">
                <div class="studDiv">
        ...
        <div class="signup-section">
            <div class="cntn1">
                ...
                ?>" placeholder="<?php echo $matt ?>" type="number" name="matric" id=""></input>    
            </div>
            <div class="cntn1">
                <label for="">Level</label>
                <select name="level" id="Level" class="lbl1">
                <option selected hidden value="No">None</option>
                    <option value="100">100 level</option><option value="200">200 level</option><option value="300">300 level</option><option value="400">400 level</option><option value="500">500 level</option>
                </select>
            </div>
        </div> 
        <?php } ?>
